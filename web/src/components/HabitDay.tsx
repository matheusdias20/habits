...
export function HabitDay({ defaultcompleted = 0, amount = 0, date }: HabitDayProps) {
    ...
    return (
        <Popover.Root>
            <Popover.Trigger 
                className={clsx("w-10 h-10 border-2 transition-colors rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 focus:ring-offset-2 focus:ring-offset-background", {
